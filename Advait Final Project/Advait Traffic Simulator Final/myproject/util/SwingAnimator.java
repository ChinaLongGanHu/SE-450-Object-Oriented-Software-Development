...
public class SwingAnimator implements Animator {
	...
	public SwingAnimator(final SwingAnimatorPainter painter, final String name,
		...
		SwingUtilities.invokeLater(() -> {
			content = new ContentPane(painter, width, height); // A paintable
																// component for
																// content
				frame = new JFrame(); // An OS window
				frame.setTitle(name); // The title of the Frame
				frame.setDefaultCloseOperation(WindowConstants.EXIT_ON_CLOSE); // End
																				// program
																				// if
																				// Frame
																				// is
																				// closed
				frame.setContentPane(content); // Associate the content with the
												// Frame
